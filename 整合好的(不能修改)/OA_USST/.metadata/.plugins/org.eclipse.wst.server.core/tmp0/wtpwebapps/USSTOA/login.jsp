...
#inputs input {
	background: #f1f1f1 url(http://www.mycodes.net/login-sprite.png)
		no-repeat;
		...
		<fieldset id="actions">
			<input type="submit" id="submit" value="Log in">
				<p>
					...
					<input type="radio"name="role" value="user" checked="checked" />用户 &nbsp&nbsp&nbsp 
					<input type="radio" name="role" value="admin" />管理员 <!-- <a href="">忘记密码?</a> -->
				</p>
		</fieldset>

		<a id="back">©2017上海理工大学办公自动化系统.All rights reserved.</a>
